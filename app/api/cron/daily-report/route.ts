...
import { getDailyUsageStats, sendUsageReportEmail } from '@/lib/reports/daily-usage';
...
export async function GET(request: Request) {
  try {
    ...
    console.log(`   Messages: ${stats.totalMessages}, Cost: $${stats.estimatedCost.toFixed(2)}`);
